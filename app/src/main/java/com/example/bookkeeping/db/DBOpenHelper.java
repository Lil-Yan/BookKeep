...
//      向typetb表当中插入元素
        ...
        db.execSQL(sql,new Object[]{"饮品", R.mipmap.ic_yanjiu,R.mipmap.ic_yanjiu_fs,0});
        ...
        db.execSQL(sql,new Object[]{"生活缴费", R.mipmap.ic_shuidianfei,R.mipmap.ic_shuidianfei_fs,0});
        ...
        db.execSQL(sql,new Object[]{"退款", R.mipmap.in_jieru,R.mipmap.in_jieru_fs,1});
        db.execSQL(sql,new Object[]{"收转账", R.mipmap.in_shouzhai,R.mipmap.in_shouzhai_fs,1});
        ...
        db.execSQL(sql,new Object[]{"报销", R.mipmap.in_yiwai,R.mipmap.in_yiwai_fs,1});
    }
